...
<body>
	...
	<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
		<div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">CRM &nbsp;<span style="font-size: 12px;">&copy;2019&nbsp;Author:&nbspT&nbspD&nbspL&nbsp;&nbsp;&nbsp;&nbsp;<img title="帅雷" src="<%=request.getContextPath() %>/image/tdl-thumbnail.png" style="width: 30px; height:30px;"></span></div>
