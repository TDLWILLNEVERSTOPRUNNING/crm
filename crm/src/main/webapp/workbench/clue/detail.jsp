...
<script type="text/javascript">
	...
	$(function(){
		...
		//为搜索市场或哦对那个绑定事件,绑定键盘敲击事件，触发回车查询并展现市场活动列表
		...
		$.ajax({
			...
			success : function(data){
				...
				$.each(data,function (i,n) {
					...
					html += '<td>'+n.endDate+'</td>';
					html += '<td>'+n.owner+'</td>';
					html += '<td><a href="javascript:void(0);"  style="text-decoration: none;" onclick="dissociated(\''+n.id+'\')"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>';
					html += '</tr>';
	...
	function dissociated(id) {
		...
		$.ajax({
			...
			url : "workbench/clue/dissociated.do",
			data : {
...
<body>
	...
	<div style="position: relative; top: 40px; left: 40px;">
		...
		<div class="remarkDiv" style="height: 60px;">
			<img title="zhangsan" src="<%=request.getContextPath() %>/image/tdl-thumbnail.png" style="width: 30px; height:30px;">
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5>哎呦！</h5>
	...
	<!--				<tr>
			...
			<div>
				<a href="javascript:void(0);" id="marketing"  style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
			</div>
		</div>
	</div>
